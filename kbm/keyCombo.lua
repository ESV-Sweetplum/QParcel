...
---@param fn `utils.IsKeyPressed` | `utils.IsKeyDown`
---@return boolean
function kbm.keyComboCheck(keyCombo, fn)
...
function kbm.pressedKeyCombo(keyCombo)
    kbm.keyComboCheck(keyCombo, utils.IsKeyPressed)
end

function kbm.holdingKeyCombo(keyCombo)
    kbm.keyComboCheck(keyCombo, utils.IsKeyDown)
end
