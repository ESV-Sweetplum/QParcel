...
function vctr4(n) return vector.New(n, n, n, n) end
...
function vctr3(n) return vector.New(n, n, n) end
...
function vctr2(n) return vector.New(n, n) end

---Creates a unit vector in the direction of `theta`.
---@param theta number The angle in radians.
---@return Vector2
function unit2(theta) return vector.New(math.cos(theta), math.sin(theta)) end
